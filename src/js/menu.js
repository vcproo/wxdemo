var homeMenu = [
  {
    ...
    'title': 'date time（日期时间）',
    'url': '../../pages/dtpicker/dtpicker'
  }, {
    'title': 'dialog（消息框）',
    ...
    'title': 'media list（图文列表）',
    'url': '../../pages/gallerylist/gallerylist'
  }, {
    'title': 'nav bar（导航栏）',
    ...
    'title': 'off canvas（侧滑导航）',
    'url': '../../pages/offcanvas/offcanvas'
  }, {
    'title': 'picker（选择器）',
    ...
    'title': 'pull to refresh（下拉刷新和上拉加载更多）',
    'url': '../../pages/pull/pull'
  }, {
    'title': 'range（滑块）',
    ...
    'title': 'indexed list（索引列表）',
    'url': '../../pages/indexed/indexed'
  }, {
    'title': 'locker（手势图案锁屏）',
    'url': '../../pages/lock/lock'
  }, {
    ...
    'title': 'bindtap (防止连续点击)',
    'url': '../../pages/bindtap/bindtap'
  }, {
    'title': 'rsa (加密/解密)',
    'url': '../../pages/rsa/rsa'
  }
